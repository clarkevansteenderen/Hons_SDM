...
# Download all available Diaphorina citri records from GBIF
...
# saveRDS(object = sp_gps_latest, file = "sp_gps_gbif.rds")
...
sp_gps_latest = readRDS("data/sp_gps_gbif.rds")
...
saveRDS(object = sp_data_thin, file = "data/sp_data_thin.rds")
...
# find the optimal threshold, based on the model
e.NR = evaluate(p = presPoints.native, a = backPoints.native, model = maxentModel1)

# View various thresholds
thresholds.NR = threshold(e.NR)
print(thresholds.NR)
